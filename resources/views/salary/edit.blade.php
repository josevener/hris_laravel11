    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Edit Employee Salary <span id="year"></span></h3>
                    <ul class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select select2s-hidden-accessible @error('name') is-invalid @enderror"
                                    style="width: 100%;">
                                    <option value="{{ old('employee_id', $salary->employee->id) }}">{{ old('employee_id', $salary->employee->user->name) }}</option>
                                </select>
                            </div>
                            @error('name')
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control @error('net_salary') is-invalid @enderror" type="number"
                                name="net_salary" id="net_salary" value="{{ old('net_salary', $salary->net_salary) }}"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('basic_salary') is-invalid @enderror" type="number"
                                    name="basic_salary" id="basic_salary" value="{{ old('basic_salary', $salary->basic_salary) }}" placeholder="Enter basic salary">
                                @error('basic_salary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('meal') is-invalid @enderror" type="number"
                                            name="meal_allowance" id="meal" value="{{ old('meal_allowance', $salary->meal_allowance) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('transportation') is-invalid @enderror" type="number"
                                            name="transpo_allowance" id="transportation" value="{{ old('transpo_allowance', $salary->transpo_allowance) }}"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('sss') is-invalid @enderror" type="number"
                                    name="sss" id="sss" value="{{ old('sss', $salary->sss) }}" placeholder="Enter SSS">
                                @error('sss')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('pag_ibig') is-invalid @enderror" type="number"
                                    name="pag_ibig" id="pag_ibig" value="{{ old('pag_ibig', $salary->pag_ibig) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('philhealth') is-invalid @enderror" type="number"
                                    name="philhealth" id="philhealth" value="{{ old('philhealth', $salary->philhealth) }}"
